        ...
        <header> 
            <div className="flex items-center bg-amazon_blue p-1"> 
                ...
                <div className='hidden sm:flex items-center h-10 rounded-md flex-grow cursor-pointer bg-yellow-400 hover:bg-yellow-500'>
                    <input type='text' className='p-2 h-full flex-grow flex-shrink rounded-l-md cursor-pointer focus:outline-none px-4' />
                    <SearchIcon  className='h-12 p-4'/>
                </div>
                <div className='text-white flex items-center text-xs space-x-6 mx-6 whitespace-nowrap'>
                    <div className='link'>
                        <p>Hello Pelumi Ogundipe</p>
           ...
           <div className='flex items-center space-x-3 p-2 pl-6 bg-amazon_blue-light text-white text-sm'> 
              ...
              <p className='link hidden lg:inline-flex'>Food and Delivery</p>
